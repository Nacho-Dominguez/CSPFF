...
class gacl {
	...
	function gacl( $db=null ) {
		...
		// backend login
		$this->_mos_add_acl( 'administration', 'login', 'users', 'court administrator', null, null );
		$this->_mos_add_acl( 'administration', 'login', 'users', 'instructor', null, null );
		$this->_mos_add_acl( 'administration', 'login', 'users', 'location administrator', null, null );
		...
		// access to content
		$this->_mos_add_acl( 'administration', 'manage', 'users', 'administrator', 'components', 'com_content' );
		$this->_mos_add_acl( 'administration', 'manage', 'users', 'super administrator', 'components', 'com_content' );
		...
		$this->_mos_add_acl( 'administration', 'install', 'users', 'court administrator', 'components', 'all' );
		$this->_mos_add_acl( 'administration', 'install', 'users', 'instructor', 'components', 'all' );
		$this->_mos_add_acl( 'administration', 'install', 'users', 'location administrator', 'components', 'all' );
		...
		// courses
		$this->_mos_add_acl( 'administration', 'edit', 'users', 'instructor', 'components', 'com_course' );
		$this->_mos_add_acl( 'administration', 'edit', 'users', 'location administrator', 'components', 'com_course' );

		$this->_mos_add_acl( 'action', 'all', 'users', 'instructor', 'course', 'own' );
		$this->_mos_add_acl( 'action', 'all', 'users', 'location administrator', 'course', 'own' );
		$this->_mos_add_acl( 'action', 'all', 'users', 'administrator', 'course', 'all' );
		$this->_mos_add_acl( 'action', 'all', 'users', 'super administrator', 'course', 'all' );

		// courts

		// I don't think Court Administrators are supposed to edit courts - Thomas
		//$this->_mos_add_acl( 'administration', 'edit', 'users', 'court administrator', 'components', 'com_court' );
		$this->_mos_add_acl( 'administration', 'edit', 'users', 'location administrator', 'components', 'com_court' );

		$this->_mos_add_acl( 'action', 'edit', 'users', 'court administrator', 'court', 'own' );
		$this->_mos_add_acl( 'action', 'save', 'users', 'court administrator', 'court', 'own' );
		$this->_mos_add_acl( 'action', 'apply', 'users', 'court administrator', 'court', 'own' );
		$this->_mos_add_acl( 'action', 'all', 'users', 'location administrator', 'court', 'own' );
		$this->_mos_add_acl( 'action', 'all', 'users', 'administrator', 'court', 'all' );
		$this->_mos_add_acl( 'action', 'all', 'users', 'super administrator', 'court', 'all' );

		// instructors
		$this->_mos_add_acl( 'administration', 'edit', 'users', 'instructor', 'components', 'com_instructor' );
		$this->_mos_add_acl( 'administration', 'edit', 'users', 'location administrator', 'components', 'com_instructor' );

		$this->_mos_add_acl( 'action', 'all', 'users', 'location administrator', 'instructor', 'own' );
		$this->_mos_add_acl( 'action', 'all', 'users', 'administrator', 'instructor', 'all' );
		$this->_mos_add_acl( 'action', 'all', 'users', 'super administrator', 'instructor', 'all' );

		// locations
		$this->_mos_add_acl( 'administration', 'edit', 'users', 'location administrator', 'components', 'com_location' );

		$this->_mos_add_acl( 'action', 'all', 'users', 'location administrator', 'location', 'own' );
		$this->_mos_add_acl( 'action', 'all', 'users', 'administrator', 'location', 'all' );
		$this->_mos_add_acl( 'action', 'all', 'users', 'super administrator', 'location', 'all' );

		// payments
		$this->_mos_add_acl( 'administration', 'edit', 'users', 'location administrator', 'components', 'com_pay' );

		// students
		$this->_mos_add_acl( 'administration', 'edit', 'users', 'court administrator', 'components', 'com_student' );
		$this->_mos_add_acl( 'administration', 'edit', 'users', 'instructor', 'components', 'com_student' );
		$this->_mos_add_acl( 'administration', 'edit', 'users', 'location administrator', 'components', 'com_student' );

		$this->_mos_add_acl( 'action', 'all', 'users', 'court administrator', 'student', 'all' );
		$this->_mos_add_acl( 'action', 'add', 'users', 'instructor', 'student', 'own' );
		$this->_mos_add_acl( 'action', 'all', 'users', 'administrator', 'student', 'all' );
		$this->_mos_add_acl( 'action', 'all', 'users', 'super administrator', 'student', 'all' );

		// stats
		$this->_mos_add_acl( 'administration', 'edit', 'users', 'location administrator', 'components', 'com_stats' );
		...
		// manage users
		$this->_mos_add_acl( 'administration', 'manage', 'users', 'location administrator', 'components', 'com_users' );
		...
		// block users property
		$this->_mos_add_acl( 'administration', 'edit', 'users', 'location administrator', 'user properties', 'block_user' );
		...
		// check messages
		$this->_mos_add_acl( 'administration', 'edit', 'users', 'court administrator', 'components', 'com_messages' );
		$this->_mos_add_acl( 'administration', 'edit', 'users', 'instructor', 'components', 'com_messages' );
		$this->_mos_add_acl( 'administration', 'edit', 'users', 'location administrator', 'components', 'com_messages' );
