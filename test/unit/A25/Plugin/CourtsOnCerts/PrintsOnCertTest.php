...
class test_unit_A25_Plugin_CourtsOnCerts_PrintsOnCertTest extends
    \test_Framework_UnitTestCase
{
    ...
    {
        require_once dirname(__FILE__) . '/../../../../../plugins/CourtsOnCerts.php';

        $tracker = new DumbCallEcho();
        $printer = new NscCert($tracker, array(new A25_Plugin_CourtsOnCerts()), new A25_CertPdfSettings_New());
...
Method: displayCentered. Args: array(1) {
  [0]=>
  string(41) "**NOT VALID FOR COURT/LEGAL PROCEEDINGS**"
}
