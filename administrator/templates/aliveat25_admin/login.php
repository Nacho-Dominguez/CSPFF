...
<style type="text/css">
@import url(templates/aliveat25_admin/css/admin_login.css);
</style>
...
<div id="wrapper">
	<div id="header">
			<div id="joomla"><?php echo PlatformConfig::courseTitleHtml() ?> Site Administration</div>
	</div>
</div>
<div id="ctr" align="center">
	...
	<div class="login">
      ...
      <h1>Login</h1>
			<form action="<?php echo A25_Link::https('/administrator/index.php')?>" method="post" name="loginForm" id="loginForm">
		...
		<div class="login-text">
			<div class="ctr"><img src="templates/aliveat25_admin/images/security.png" width="64" height="64" alt="security" /></div>
