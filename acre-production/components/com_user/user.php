...
switch( $task ) {
	case 'saveUpload':
		...
		if ( $_VERSION->RESTRICT == 1 ) {
			A25_DI::Redirector()->redirect( 'index.php?mosmsg=Functionality Restricted' );
		} else {
...
function userSave( $option, $uid) {
	...
	$row = A25_Record_User::retrieve( $user_id );
	...
	A25_DI::Redirector()->redirect( 'index.php', _USER_DETAILS_SAVE );
}
