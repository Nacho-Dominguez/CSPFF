...
class test_unit_A25_Record_Course_IsPastPaymentDeadlineTest extends
		test_Framework_UnitTestCase
{
	...
	public function itHas()
	{
		$this->course->setCourseTime(strtotime($this->location->payment_deadline
				. ' hours - 2 minute'));
		$this->assertTrue($this->course->isPastPaymentDeadline());
    }
	/**
	 * @test
	 */
	public function itHasNot()
	{
		$this->course->setCourseTime(strtotime($this->location->payment_deadline
				. ' hours'));
		$this->assertFalse($this->course->isPastPaymentDeadline());
    }
}
?>
