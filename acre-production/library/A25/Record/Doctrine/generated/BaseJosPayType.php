 ...
 */
abstract class BaseJosPayType extends A25_DoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('jos_pay_type');
        $this->hasColumn('pay_type_id', 'integer', 4, array(
             'type' => 'integer',
             'length' => 4,
             'fixed' => false,
             'unsigned' => true,
        ...
        $this->hasColumn('pay_type_name', 'string', 20, array(
             'type' => 'string',
             'length' => 20,
             'fixed' => false,
             'unsigned' => false,
