 ...
 */
abstract class BaseJosCourseType extends A25_DoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('jos_course_type');
        ...
        $this->hasColumn('type_key', 'string', 1, array(
             'type' => 'string',
             'length' => 1,
             'fixed' => true,
             'unsigned' => false,
        ...
        $this->hasColumn('type_name', 'string', 20, array(
             'type' => 'string',
             'length' => 20,
             'fixed' => false,
             'unsigned' => false,
