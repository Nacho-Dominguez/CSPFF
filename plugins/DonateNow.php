...
class A25_Plugin_DonateNow implements
    ...
    A25_ListenerI_BannerAd
{
    ...
    {
        echo '<dt><a href="list-donations">Independent (non-student) Donations</a></dt>';
    }
    ...
    public function afterAdminButtons()
    {
        ...
        $link = 'admin-donate';
        quickiconButton($link, 'heart_small.png', 'Donation');
    }
...
<img style="margin-top: 8px; margin-bottom: 4px;" src="<?php echo A25_Link::to('/images/heart_small.png')?>" alt="General donation" width="38px" /></span>
Donate out of the goodness of your heart
</a>
<a href="<?php echo A25_Link::to('court-ordered-donation')?>" class="donate-button">
<span class="donate-image">
<img style="margin-top: 4px; margin-bottom: 12px;" src="<?php echo A25_Link::to('/images/sivvus_scales_small.png')?>" alt="Court-ordered donation" width="40px" /></span>
...
set_include_path(
    ServerConfig::webRoot . '/plugins/DonateNow' . PATH_SEPARATOR
    . get_include_path()
);
