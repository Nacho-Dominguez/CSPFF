...
class Controller_Administrator_AdminFundDonate extends Controller
{
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#ffffff', endColorstr='#e5e5e5',GradientType=0 ); /* IE6-8 */
    ...
    <a href="<?php echo A25_Link::to('/administrator/fund-donation-without-processing')?>" class="donate-button">
