...
class PlatformConfig extends PlatformConfigState
{
  ...
  // hidden
    ...
    {
        return new A25_ColorScheme_Red();
    }

    const courseTitle = 'DDC Motorcycle';
    const courseTitleFull = 'DDC Motorcycle Safety Program';
    const siteTitle = 'DDC Motorcycle';

    const defaultCourtFee = 39;
    ...
    {
        return "/component/option,com_course/task,confirm/course_id,2/Itemid,19/";
    }
